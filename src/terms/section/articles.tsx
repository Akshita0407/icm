...
const articlesData = [
...

  {
    ...
    sections: [
      {
        paragraphs: [
          "These Legal Terms shall be governed by and defined following the laws of India. iCreate Media Pvt Ltd and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.",
        ],
      },
    ],
  },

  {
    ...
    sections: [
      ...
      {
        paragraphs: [
          "Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be one (1). The seat, or legal place, or arbitration shall be Chandigarh, India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of India.",
        ],
      },
      {
    ...
    sections: [
      {
        paragraphs: [
          ...
          <a key="email" href="" className="text-blue-500 underline">
            sales@icreate-media.com
          </a>,
        ],
      },
